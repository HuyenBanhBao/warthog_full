...
if("TRUE" STREQUAL "TRUE")
  set(rosparam_shortcuts_SOURCE_PREFIX /home/tung/warthog_full/src/rosparam_shortcuts)
  set(rosparam_shortcuts_DEVEL_PREFIX /home/tung/warthog_full/devel)
  ...
  set(rosparam_shortcuts_INSTALL_PREFIX /home/tung/warthog_full/install)
...
if(NOT "/home/tung/warthog_full/src/rosparam_shortcuts/include;/usr/include/eigen3 " STREQUAL " ")
  set(rosparam_shortcuts_INCLUDE_DIRS "")
  set(_include_dirs "/home/tung/warthog_full/src/rosparam_shortcuts/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosparam_shortcuts' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tung/warthog_full/src/rosparam_shortcuts/${idir}'.  ${_report}")
    endif()
